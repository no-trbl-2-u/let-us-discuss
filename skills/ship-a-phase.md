...
`plan/steps/01_build_plan.md` carves boardroom into ~10–20 phases.
...
**Brief:** [\`plan/phases/phase_<N>_<topic>.md\`](https://github.com/no-trbl-2-u/let-us-discuss/blob/main/plan/phases/phase_<N>_<topic>.md)
