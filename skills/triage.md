...
GH_REPO=no-trbl-2-u/let-us-discuss           # optional; defaults to no-trbl-2-u/let-us-discuss
```
...
GH_REPO=${GH_REPO:-no-trbl-2-u/let-us-discuss}
...
[plan/AUDIT.md](https://github.com/no-trbl-2-u/let-us-discuss/blob/main/plan/AUDIT.md)
