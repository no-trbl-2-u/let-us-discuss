---
name: plan-a-phase
description: Refine or generate one phase brief. Writes to `plan/phases/phase_<N>_<topic>.md`. Does NOT modify code. Use when a phase brief is missing or stale before shipping — `/plan-a-phase`, "draft the phase N brief", "refresh this brief", or invoked inline by `/ship-a-phase` when the brief doesn't exist yet.
---
